    ...
    _0x76bf4.ev.on("connection.update", _0x4eb449 => {
      ...
      if (_0x237ed1 === "close") {
        ...
        if (initialConnection) {
          console.log(_0x4b0fc4.green("HANS MD CONNECTED SUCCESSFULLY ✅"));
...
app.get('/', (_0x1ecf21, _0x282bcc) => {
  _0x282bcc.send("HANS MD CONNECTED SUCCESSFULLY ✅");
});
app.listen(PORT, () => {
